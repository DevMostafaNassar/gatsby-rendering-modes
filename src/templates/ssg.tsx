...
export default function SSG(props: any) {
  // Normal static site generation SSG and server-side call the API
  // "Counted at First site build"
  const {
    pageContext: { dogImage },
  } = props;
  console.log("SSG Template", dogImage);
