...
export default function ssgPage(props: any) {
  ...
  useEffect(() => {
    (async () => {
      ...
      //This get updated after build but client-side rendered call
      //page renerers twice -first without image -second after image url get fetched
      console.log("SSG page image", await image.message);
    ...
    <main>
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <h1 className="w-full text-left text-lg font-semibold leading-7 text-zinc-600 my-4">
          Static Site Generation page and call API after page mount "data exist
          at build time"
        </h1>
